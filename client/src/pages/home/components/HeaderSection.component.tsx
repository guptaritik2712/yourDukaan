    ...
    return (
        ...
        >
            <h1
                ...
                mobile-md:text-3xl"
            >
                Your Store, Your Way - yourDukaan!
            </h1>
            <p
                ...
                mobile-md:px-2"
            >
                Discover yourDukaan, your perfect online shopping destination! From the latest gadgets to everyday essentials, 
                enjoy amazing deals, seamless checkout, and lightning-fast delivery. Transform your shopping experience with ease. 
                Start your yourDukaan journey today!
            </p>
            <nav
